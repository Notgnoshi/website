"""
Django settings for research_agill_xyz project.
...
# Static site configuration taken from http://goodcode.io/articles/django-staticsite/
import os
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'research_agill_xyz.constants.domain_constants',
                'research_agill_xyz.constants.subdomain_constants',
            ]
        }
    },
]
